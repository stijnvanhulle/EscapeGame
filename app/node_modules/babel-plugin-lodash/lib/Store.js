...
var Store = function (_MapCache) {
  ...
  _createClass(Store, [{
    ...
    value: function get(pkgPath) {
      return _get(Object.getPrototypeOf(Store.prototype), 'get', this).call(this, (0, _util.normalizePath)(pkgPath));
    }
  }, {
    key: 'set',
    value: function set(pkgPath) {
      var pkgStore = arguments.length <= 1 || arguments[1] === undefined ? new _Package2.default((0, _util.normalizePath)(pkgPath)) : arguments[1];

      return _get(Object.getPrototypeOf(Store.prototype), 'set', this).call(this, (0, _util.normalizePath)(pkgPath), pkgStore);
    }
  }]);
