...
* @Last modified time: 2016-12-27T22:56:52+01:00
...
class Prison extends Component {
  ...
  onLoad = () => {
    ...
    let hides = [$('.smoke'), $('.prison svg #mountains'), $('.prison svg #horizon'), $('.prison svg #nuclear')];
    ...
    if (canStart) {
      ...
      for (var i = 0; i < hides.length; i++) {
        ...
        self.props.data.showText=false;
      if (prison) {
