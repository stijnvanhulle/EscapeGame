	...
	public class CameraPageRenderer : PageRenderer, TextureView.ISurfaceTextureListener
	{
		...
		void SetupUserInterface()
		{
			...
			RelativeLayout.LayoutParams captureButtonParams = new RelativeLayout.LayoutParams(
				...
				RelativeLayout.LayoutParams.WrapContent);
			captureButtonParams.Height = 200;
			captureButtonParams.Width = 200;
		...
		protected override void OnLayout(bool changed, int l, int t, int r, int b)
		{
			...
			capturePhotoButton.SetX( mainLayout.Width/2-100);
			capturePhotoButton.SetY(mainLayout.Height/2-100);
		}
		...
		public void SetupEventHandlers()
		{
			capturePhotoButton.Click += async (sender, e) =>
			{
                ...
                //(Element as Page3).GetImage(bytes, liveView.Bitmap.Width, liveView.Bitmap.Height);
			};
